...
public class Powers : MonoBehaviour {
	...
	void Start () {
		if (Network.peerType != NetworkPeerType.Disconnected){
			groupmob = ressource.GetComponent<WaveSpawnScript>().getLesMonstres();
		}
		else{
			groupmob = ressource.GetComponent<Wave>().getLesMonstres();
		}
	...
	[RPC]
	void EnvoyerUnBoss(){
		ressource.GetComponent<WaveSpawnScript> ().envoieBoss ();
	}
